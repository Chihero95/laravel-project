              ...
              <!-- /.box-tools -->
                ...
                @include('includes.message')
                    ...
                    <div class="form-group @if($errors->has('img')) has-error @endif ">
                        ...
                        <div id="preview">
                            <!-- Phần này cũng thiếu s ở images vì nó gọi hàm relationship (images) trong model products-->
...
<script>
    $(document).ready(function(){
        ...
        function previewImages(){
            var $preview = $('#privew').empty();
            if(this.files) $.each(this.files, readAndPrivew);
            function readAndPrivew(i, file){
